...
const observer2 = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    ...
    const Keyword_element_4 = entry.target.querySelector('.keyword_list li:nth-child(4)');
    ...
    if (entry.isIntersecting) {
      ...
      Keyword_element_4.classList.add('Keyword_element_animate');
    ...
    Keyword_element_4.classList.remove('Keyword_element_animate');
  });
});
...
function showList_2() {
    var x = document.getElementById("service_list_affaire");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function showList_4() {
    var x = document.getElementById("service_list_Succession");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
